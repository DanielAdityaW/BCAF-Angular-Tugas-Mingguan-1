import { ITodo } from "../../feature/todos/components/interface/i-todo";
import { MOCK_TODOS } from "../mocks/todo.mocks";
...
export class TodoService {
  ...
  restore(id:number){
    ...
    if (todoRestore) {
        ...
        let payload: ITodo[] = this.trashTodos.filter((value: ITodo) => value.id !== id);
